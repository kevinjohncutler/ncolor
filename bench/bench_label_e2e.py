"""End-to-end ncolor.label benchmark — full pipeline, p=2 (L2)."""
import time
...
print(f"{'shape':<14} {'best':>10} {'med':>10} {'stdev':>10}")
for name, m in shapes:
    best, med, std = bench(lambda m=m: ncolor.label(m, p=2, expand=True))
