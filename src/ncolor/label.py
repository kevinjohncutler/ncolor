...
# ── Euclidean Voronoi expand_labels (Felzenszwalb separable, ND) ───────────────
...
def expand_labels(label_image):
    ...
    Huttenlocher 2012) implemented in Numba. Works for any ndim. Falls back to
    scipy.ndimage when Numba is unavailable.
    """
